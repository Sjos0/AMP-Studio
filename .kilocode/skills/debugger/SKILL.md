...
|-------|---------------------|---------------------|
| `code-archaeologist` | Legacy code context, historical changes | Bug reproduction steps, error patterns |
| `test-engineer` | Regression tests, test coverage | Failing test cases, edge cases |
| `security-auditor` | Vulnerability patterns, security logs | Error messages, stack traces |
| `performance-optimizer` | Performance metrics, profiling data | Slow operations, bottlenecks |
| `project-planner` | Bug impact assessment, fix estimates | Root cause, affected components |
